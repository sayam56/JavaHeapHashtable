...
public class CuckooHashTable<AnyType>
{
 ...
 public static void main( String [ ] args )
 {
     ...
     System.out.println( "Time used for insertion in nanos: " + ( end - start ) );
     
     
     start = System.nanoTime( );
     // 10 searches
     for( int i = 0; i < 10; i++) {
    	 int int_random = rand.nextInt(NUMS); 
    	 System.out.println( "Searching for..."+int_random );
    	 System.out.println( H.contains( ""+int_random ) );
     }
     end = System.nanoTime( ); 
     System.out.println( "Time used for searching in nanos: " + ( end - start ) );
